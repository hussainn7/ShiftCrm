  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        "in-progress": "border-transparent bg-blue-500 text-white hover:bg-blue-500/80",
        "under-review": "border-transparent bg-amber-500 text-white hover:bg-amber-500/80",
        "completed": "border-transparent bg-green-500 text-white hover:bg-green-500/80",
        "canceled": "border-transparent bg-red-500 text-white hover:bg-red-500/80",
      },
    },
    defaultVariants: {
      variant: "default",
...
export interface BadgeProps
  extends React.HTMLAttributes<HTMLDivElement>,
    VariantProps<typeof badgeVariants> {
      variant?: "default" | "secondary" | "destructive" | "outline" | "success" | "warning" | "info" | Status;
    }
